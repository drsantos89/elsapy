"""The (abstract) base entity module for elsapy. Used by elsprofile, elsdoc. Additional
resources:
...
class ElsEntity(metaclass=ABCMeta):
    ...
    def write(self):
        """If data exists for the entity, writes it to disk as a .JSON file with the
